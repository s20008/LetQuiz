...
object Constants {
    ...
    fun getQuestions(count: Int): MutableList<Question> {
        ...
        val que1 = Question(
            1, "源氏物語の作者は誰ですか？",
            R.drawable.s20008_wakamurasaki,"不明", "紫式部", "兼好法師", "夏目漱石", 2
        )
        val que2 = Question(
            2, "745年の8月19日は、絶世の美女であった楊貴妃が唐・玄宗皇帝の妃となった「楊貴妃の日」です。さて、楊貴妃という通称ですが、、、どこで切る？",
            R.drawable.s20008_yangguifei, "楊・貴妃", "楊貴・妃", "楊・貴・妃", "分からない", 1
        )
        val que3 = Question(
        ...
        val que10 = Question(
            10, "理想も（）もない",
            R.drawable.s20008_hechima, "糸瓜", "胡瓜", "西瓜", "冬瓜", 1
        )
        val que11 = Question(
            11, "血糖値を減少させる効果がある、すい臓のランゲルハンス島β細胞から分泌されるホルモンは？",
            R.drawable.s20008_hormone, "グルカゴン", "バソプレシン", "ソマトスタチン", "インシュリン", 4
        )
        val que12 = Question(
        ...
        val que13 = Question(
            ...
            R.drawable.s20008_kotowaza, "耳", "鼻", "口", "手", 2
        )
        val que14 = Question(
